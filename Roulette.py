...
#       remove if else statements in spin functions,

#create window
root=tk.Tk()
root.title="Roulette"
root.geometry("484x249")  #will the resolution look the same on all systems?
...
def spincolor(color):
    ...
    if spin==0:
        return False
    elif(color==0 and spin in red) or (not color==0 and not spin in red):
        return True
    else:
        return False
      
#payout function    
def payout(spintype, odds, one, two): #spintype is for determining function & the odds determine the payout
    #uses dictionary
    spin_checks = {
...
f1.grid(row=0,column=0,sticky="ew")
    #side green buttons
g0=tk.Button(f1, text="0", bg="green", fg="white", width=2, command=partial(payout,1,35,0,0))
g0.grid(row=1, column=0, padx=5, pady=5)
gRow0=tk.Button(f1, text="2 to 1", bg="green", fg="white", command=partial(payout,2,2,0,3))
gRow0.grid(row=0, column=13, padx=5, pady=5)
gRow1=tk.Button(f1, text="2 to 1", bg="green", fg="white", command=partial(payout,2,2,2,3))
gRow1.grid(row=1, column=13, padx=5, pady=5)
gRow2=tk.Button(f1, text="2 to 1", bg="green", fg="white", command=partial(payout,2,2,1,3))
gRow2.grid(row=2, column=13, padx=5, pady=5)
    #red&black number buttons
r3=tk.Button(f1, text="3", bg="red", fg="white", width=2,command=partial(payout,1,35,3,3))
r3.grid(row=0, column=1, padx=5, pady=5)
b2=tk.Button(f1, text="2", bg="black", fg="white", width=2,command=partial(payout,1,35,2,2))
b2.grid(row=1, column=1, padx=5, pady=5)
r1=tk.Button(f1, text="1", bg="red", fg="white", width=2,command=partial(payout,1,35,1,1))
r1.grid(row=2, column=1, padx=5, pady=5)
b6=tk.Button(f1, text="6", bg="black", fg="white", width=2,command=partial(payout,1,35,6,6))
b6.grid(row=0, column=2, padx=5, pady=5)
r5=tk.Button(f1, text="5", bg="red", fg="white", width=2,command=partial(payout,1,35,5,5))
r5.grid(row=1, column=2, padx=5, pady=5)
b4=tk.Button(f1, text="4", bg="black", fg="white", width=2,command=partial(payout,1,35,4,4))
b4.grid(row=2, column=2, padx=5, pady=5)
r9=tk.Button(f1, text="9", bg="red", fg="white", width=2,command=partial(payout,1,35,9,9))
r9.grid(row=0, column=3, padx=5, pady=5)
b8=tk.Button(f1, text="8", bg="black", fg="white", width=2,command=partial(payout,1,35,8,8))
b8.grid(row=1, column=3, padx=5, pady=5)
r7=tk.Button(f1, text="7", bg="red", fg="white", width=2,command=partial(payout,1,35,7,7))
r7.grid(row=2, column=3, padx=5, pady=5)
r12=tk.Button(f1, text="12", bg="red", fg="white",command=partial(payout,1,35,12,12))
r12.grid(row=0, column=4, padx=5, pady=5)
b11=tk.Button(f1, text="11", bg="black", fg="white",command=partial(payout,1,35,11,11))
b11.grid(row=1, column=4, padx=5, pady=5)
b10=tk.Button(f1, text="10", bg="black", fg="white",command=partial(payout,1,35,10,10))
b10.grid(row=2, column=4, padx=5, pady=5)
b15=tk.Button(f1, text="15", bg="black", fg="white",command=partial(payout,1,35,15,15))
b15.grid(row=0, column=5, padx=5, pady=5)
r14=tk.Button(f1, text="14", bg="red", fg="white",command=partial(payout,1,35,14,14))
r14.grid(row=1, column=5, padx=5, pady=5)
b13=tk.Button(f1, text="13", bg="black", fg="white",command=partial(payout,1,35,13,13))
b13.grid(row=2, column=5, padx=5, pady=5)
r18=tk.Button(f1, text="18", bg="red", fg="white",command=partial(payout,1,35,18,18))
r18.grid(row=0, column=6, padx=5, pady=5)
b17=tk.Button(f1, text="17", bg="black", fg="white",command=partial(payout,1,35,17,17))
b17.grid(row=1, column=6, padx=5, pady=5)
r16=tk.Button(f1, text="16", bg="red", fg="white",command=partial(payout,1,35,16,16))
r16.grid(row=2, column=6, padx=5, pady=5)
r21=tk.Button(f1, text="21", bg="red", fg="white",command=partial(payout,1,35,21,21))
r21.grid(row=0, column=7, padx=5, pady=5)
b20=tk.Button(f1, text="20", bg="black", fg="white",command=partial(payout,1,35,20,20))
b20.grid(row=1, column=7, padx=5, pady=5)
r19=tk.Button(f1, text="19", bg="red", fg="white",command=partial(payout,1,35,19,19))
r19.grid(row=2, column=7, padx=5, pady=5)
b24=tk.Button(f1, text="24", bg="black", fg="white",command=partial(payout,1,35,24,24))
b24.grid(row=0, column=8, padx=5, pady=5)
r23=tk.Button(f1, text="23", bg="red", fg="white",command=partial(payout,1,35,23,23))
r23.grid(row=1, column=8, padx=5, pady=5)
b22=tk.Button(f1, text="22", bg="black", fg="white",command=partial(payout,1,35,22,22))
b22.grid(row=2, column=8, padx=5, pady=5)
r27=tk.Button(f1, text="27", bg="red", fg="white",command=partial(payout,1,35,27,27))
r27.grid(row=0, column=9, padx=5, pady=5)
b26=tk.Button(f1, text="26", bg="black", fg="white",command=partial(payout,1,35,26,26))
b26.grid(row=1, column=9, padx=5, pady=5)
r25=tk.Button(f1, text="25", bg="red", fg="white",command=partial(payout,1,35,25,25))
r25.grid(row=2, column=9, padx=5, pady=5)
r30=tk.Button(f1, text="30", bg="red", fg="white",command=partial(payout,1,35,30,30))
r30.grid(row=0, column=10, padx=5, pady=5)
b29=tk.Button(f1, text="29", bg="black", fg="white",command=partial(payout,1,35,29,29))
b29.grid(row=1, column=10, padx=5, pady=5)
b28=tk.Button(f1, text="28", bg="black", fg="white",command=partial(payout,1,35,28,28))
b28.grid(row=2, column=10, padx=5, pady=5)
b33=tk.Button(f1, text="33", bg="black", fg="white",command=partial(payout,1,35,33,33))
b33.grid(row=0, column=11, padx=5, pady=5)
r32=tk.Button(f1, text="32", bg="red", fg="white",command=partial(payout,1,35,32,32))
r32.grid(row=1, column=11, padx=5, pady=5)
b31=tk.Button(f1, text="31", bg="black", fg="white",command=partial(payout,1,35,31,31))
b31.grid(row=2, column=11, padx=5, pady=5)
r36=tk.Button(f1, text="36", bg="red", fg="white",command=partial(payout,1,35,36,36))
r36.grid(row=0, column=12, padx=5, pady=5)
b35=tk.Button(f1, text="35", bg="black", fg="white",command=partial(payout,1,35,35,35))
b35.grid(row=1, column=12, padx=5, pady=5)
r34=tk.Button(f1, text="34", bg="red", fg="white",command=partial(payout,1,35,34,34))
...
f2.grid(row=1,column=0,sticky="ew")
    #dozen buttons
g1st12=tk.Button(f2, text="1st 12", bg="green", fg="white", width=16,command=partial(payout,1,2,1,12))
g1st12.grid(row=0,column=1, padx=5, pady=5)
g2nd12=tk.Button(f2, text="2nd 12", bg="green", fg="white", width=16,command=partial(payout,1,2,13,24))
g2nd12.grid(row=0,column=2, padx=6, pady=5)
g3rd12=tk.Button(f2, text="3rd 12", bg="green", fg="white", width=16,command=partial(payout,1,2,25,36))
...
g1to18=tk.Button(f3, text="1 to 18", bg="green", fg="white", width=6,command=partial(payout,1,1,1,18))
g1to18.grid(row=0, column=1, padx=5, pady=5)
gEVEN=tk.Button(f3, text="EVEN", bg="green", fg="white", width=6,command=partial(payout,2,1,0,2))
gEVEN.grid(row=0, column=2, padx=13, pady=5)
gRED=tk.Button(f3, text="◆", bg="green", fg="red", width=7,command=partial(payout,3,1,0,99))
gRED.grid(row=0, column=3, pady=5)
gBLACK=tk.Button(f3, text="◆", bg="green", fg="black", width=7,command=partial(payout,3,1,99,99))
gBLACK.grid(row=0, column=4, pady=5)
gODD=tk.Button(f3, text="ODD", bg="green", fg="white", width=6,command=partial(payout,2,1,1,2))
gODD.grid(row=0, column=5, padx=14, pady=5)
g19to36=tk.Button(f3, text="19 to 36", bg="green", fg="white", width=6,command=partial(payout,1,1,19,36))
...
c4=tk.Button(f5, text="$1000", bg="black", fg="white", command=partial(changeBet,1000))
c4.grid(row=0, column=4, padx=5, pady=5)
c5=tk.Button(f5, text="$5000", bg="blue", fg="white", command=partial(changeBet,5000))
...
betLabel = tk.Label(f5, textvariable=betDisplay, font=("Times New Roman", 13), bg="white", width=9)
betLabel.grid(row=0, column=7, pady=5)
chipsDisplay = tk.StringVar(value="Chips: $" + str(chips.get()))
chipsLabel = tk.Label(f5, textvariable=chipsDisplay, font=("Times New Roman", 13), bg="gray90")
chipsLabel.grid(row=0, column=8, padx=5, pady=5)
spinDisplay = tk.StringVar(value="Roll: " + str(spinResult.get()))
lastSpinLabel=tk.Label(f4,textvariable=spinDisplay, font=("Times New Roman",13),bg="ivory", width=9)
